 ...
 */
@property(nonatomic, strong, nullable) RTCAudioSessionConfiguration *previousConfiguration;
@property(nonatomic, strong) NSMutableArray<RTCAudioSessionConfiguration *> *configurationStack;
