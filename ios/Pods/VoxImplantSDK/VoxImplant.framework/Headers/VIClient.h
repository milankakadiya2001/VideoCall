...
/**
 * Triggered after connection to Voximplant Cloud was established successfully after a reconnect.
 *
...
/**
 * Triggered when previously received VoIP push notification is expired, i.e. <[VIClientCallManagerDelegate client:didReceiveIncomingCall:withIncomingVideo:headers:]> will not be invoked for the specified callKitUUID.
 *
 ...
 * For details see [the video conferencing guide](/blog/video-conference-through-voximplant-media-servers).
 *
